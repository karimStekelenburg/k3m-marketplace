...
- `/feedback hook-development skill is missing FileChanged event type`
- `/feedback plugin-dev scaffolding doesn't include LSP configuration`
- `/feedback scope-validation flagged a false positive on shared config`
