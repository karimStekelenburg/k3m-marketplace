...
description: >-
  ...
  or needs to manage the meta-dev resource list. Provides guidance for maintaining
  the master resources.json that drives the discovery pipeline.
---

# Resource Management

Maintain the master resource list at `data/resources.json` that drives meta-dev's
