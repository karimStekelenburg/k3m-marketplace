---
description: Process accumulated feedback and propose improvements to marketplace plugins. Use when ready to review and act on feedback collected via /marketplace-maintenance:feedback.
---
